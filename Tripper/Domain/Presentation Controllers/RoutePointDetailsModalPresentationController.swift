//
//  RoutePointDetailsModalPresentationController.swift
//  Tripper
//
...
final class RoutePointDetailsModalPresentationController: UIPresentationController {
...
//    }()
    ...
    override var frameOfPresentedViewInContainerView: CGRect {
        ...
        return CGRect(x: 0, y: presentedYOffset, width: container.bounds.width, height: container.bounds.height)
    }
    ...
    @objc func didPan(pan: UIPanGestureRecognizer) {
        guard let view = pan.view, let superView = view.superview, let presented = presentedView,
